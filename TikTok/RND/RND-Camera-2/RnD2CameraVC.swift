...
//import NextLevel
//
//class RnD2CameraVC: UIViewController {
//
...
//            let albumAssetCollection = self.albumAssetCollection(withTitle: RnD2CameraVC.nextLevelAlbumTitle)
//            if albumAssetCollection == nil {
//                let changeRequest = PHAssetCollectionChangeRequest.creationRequestForAssetCollection(withTitle: RnD2CameraVC.nextLevelAlbumTitle)
//                _ = changeRequest.placeholderForCreatedAssetCollection
//            }}, completionHandler: { (_: Bool, _: Error?) in
//                if let albumAssetCollection = self.albumAssetCollection(withTitle: RnD2CameraVC.nextLevelAlbumTitle) {
//                    PHPhotoLibrary.shared().performChanges({
...
//
//extension RnD2CameraVC: UIGestureRecognizerDelegate {
//
...
//
//extension RnD2CameraVC: NextLevelDelegate {
//
//    // permission
...
//}
//
//extension RnD2CameraVC: NextLevelPreviewDelegate {
//
//    // preview
...
//}
//
//extension RnD2CameraVC: NextLevelDeviceDelegate {
//
...
//
//extension RnD2CameraVC: NextLevelFlashAndTorchDelegate {
//
...
//
//extension RnD2CameraVC: NextLevelVideoDelegate {
//
//    // video zoom
...
//
//extension RnD2CameraVC: NextLevelPhotoDelegate {
...
//                               let photoImage = UIImage(systemName: data) {
//                                let assetChangeRequest = PHAssetChangeRequest.creationRequestForAsset(from: photoImage)
//                                let assetCollectionChangeRequest = PHAssetCollectionChangeRequest(for: albumAssetCollection)
//                                let enumeration: NSArray = [assetChangeRequest.placeholderForCreatedAsset!]
//                                assetCollectionChangeRequest?.addAssets(enumeration)
...
//// MARK: - KVO
//
//private var RnD2CameraVCNextLevelCurrentDeviceObserverContext = "RnD2CameraVCNextLevelCurrentDeviceObserverContext"
//
//extension RnD2CameraVC {
//
//    internal func addKeyValueObservers() {
//        self.addObserver(self, forKeyPath: "currentDevice", options: [.new], context: &RnD2CameraVCNextLevelCurrentDeviceObserverContext)
//    }
//
...
//        if context == &RnD2CameraVCNextLevelCurrentDeviceObserverContext {
...
//}
//
//extension RnD2CameraVC: NextLevelMetadataOutputObjectsDelegate {
//
